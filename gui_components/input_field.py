...
class InputField(Entry):
    ...
    def __init__(self, window_type, font, default_text, is_editable=True, background_color=white, text_color=black):
        ...
        self.configure(fg=text_color, bg=background_color)
