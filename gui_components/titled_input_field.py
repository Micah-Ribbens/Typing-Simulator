...
class TitledInputField:
    ...
    def __init__(self, window_type, font, input_field_default_text, title_field_text, title_field_color=black, title_field_text_color=white):
        """Initializes the object"""

        self.title_field = InputField(window_type, font, title_field_text, False, background_color=title_field_color, text_color=title_field_text_color)
    ...
    def get_title(self):
        ...
        return self.title_field.get_text()
