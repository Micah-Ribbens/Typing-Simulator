# Gives the Hex values for the code below (the rightmost list is the rgb and the thing to the left converts it into hex)
...
dodger_blue = "#" + '%02x%02x%02x' % (30, 144, 255)
